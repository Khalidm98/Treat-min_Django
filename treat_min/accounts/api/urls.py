...
from .views import RegisterEmailAPI, RegisterCodeAPI, RegisterAPI, LoginAPI, ChangePasswordAPI,\
    PasswordEmailAPI, PasswordCodeAPI, PasswordResetAPI, ChangePhotoAPI, EditAccountAPI, UserDataAPI
...
urlpatterns = [
    ...
    path('edit-account/', EditAccountAPI.as_view(), name='edit_account'),
