...
class ClinicDetail(Detail):
    hospital = models.ForeignKey(Hospital, on_delete=models.RESTRICT, related_name='clinics_details', verbose_name=_("hospital"))
    clinic = models.ForeignKey(Clinic, on_delete=models.RESTRICT, related_name='details', verbose_name=_("clinic"))
    doctor = models.ForeignKey(Doctor, on_delete=models.CASCADE, related_name='clinics_details', verbose_name=_("doctor"))
...
class RoomDetail(Detail):
    hospital = models.ForeignKey(Hospital, on_delete=models.RESTRICT, related_name='rooms_details', verbose_name=_("hospital"))
...
class ServiceDetail(Detail):
    hospital = models.ForeignKey(Hospital, on_delete=models.RESTRICT, related_name='services_details', verbose_name=_("hospital"))
